...
#define MAX_NUMBER_OF_LINE 46	//max number of elements on a line
#define MAX_NUMBER_OF_DATA 32 //max number of data elements on a line
#define MAX_LINE 200
/************PIN MAP******************************
...
//volatile HexTypeDef aHex[MAX_LINE];
...
int main(void)
{
  ...
  /* USER CODE BEGIN 1 */
//	aHex =  malloc(500* sizeof(HexTypeDef));
  /* USER CODE END 1 */
